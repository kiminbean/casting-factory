...
class ManagementService(object):
    ...
    def StartProduction(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/StartProduction',
    ...
    def ListItems(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/ListItems',
    ...
    def AllocateItem(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/AllocateItem',
    ...
    def PlanRoute(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/PlanRoute',
    ...
    def ExecuteCommand(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/ExecuteCommand',
    ...
    def WatchItems(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/casting.management.v1.ManagementService/WatchItems',
    ...
    def WatchAlerts(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/casting.management.v1.ManagementService/WatchAlerts',
    ...
    def Health(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/casting.management.v1.ManagementService/Health',
...
class ImagePublisherService(object):
    ...
    def PublishFrames(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_unary(request_iterator, target, '/casting.management.v1.ImagePublisherService/PublishFrames',
