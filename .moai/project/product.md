...
4단계 발주 폼 (제품 선택 → 사양 → 고객 정보 → 확인):
- 4개 제품 중 선택: 맨홀 뚜껑 KS D-450/D-600/D-800, 배수구 그레이팅 500x300
- 사양: 직경, 두께, 재질(FC200/FC250/GCD450/GCD500), 하중 등급, 후처리 옵션
- 고객 정보 + 배송지 + 요청 납기
- 제출 시 `/api/orders` + `/api/orders/{id}/details` POST
