...
> **마지막 업데이트**: 2026-04-21 (cron sync: 18건)
...
``
``
| Management Service | Monitoring Service | 🟠 TCP ↔ | StatusStream.pub | (실시간 공정 모니터링/공장 좌표/이상 알림) |
``
``
| Monitoring Service | Management Service | 🟠 TCP ↔ | ControlCommand.req | JSON/Binary (장비 제어/모드 변경 요청) |
``
| Management Service | Monitoring Service | 🟠 | ControlCommand.res | JSON/Binary (제어 결과/현재 상태) |
...
| From | To |   | Interface Item | Message Format |
|---|---|---|---|---|
``
| Management Service | AI Service | 🟠 TCP `` | InferenceRequest/Response | JSON + Image Buffer |
``
| Management Service | DB Service | 🟠 TCP `` |   | SQL/JSON Query |
...
| Standup | Standup_260420_2팀 |   |   | 제출 |
