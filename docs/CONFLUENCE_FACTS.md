...
> **마지막 업데이트**: 2026-04-20 (cron sync: 13건)
...
| 로딩 | Loading | LD | 컨베이어벨트에 반입 |
| 언로딩 | Unloading | DLD | 컨베이어벨트에 반출 |
