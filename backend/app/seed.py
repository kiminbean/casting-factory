...
def _seed_orders(db: Session) -> None:
    if db.query(Order).count() > 0:
        return
    rows = [
        Order(id="ORD-2026-001", customer_id="CUST-001", customer_name="김철수", company_name="(주)한국도로공사", contact="02-1234-5678", shipping_address="서울특별시 성동구 용답동 123-4", total_amount=4250000, status="in_production", requested_delivery="2026-04-15", confirmed_delivery="2026-04-12", created_at="2026-03-25T09:00:00", updated_at="2026-03-28T14:30:00"),
        Order(id="ORD-2026-002", customer_id="CUST-002", customer_name="이영희", company_name="(주)서울시설공단", contact="02-2345-6789", shipping_address="서울특별시 중구 세종대로 110", total_amount=3600000, status="approved", requested_delivery="2026-04-20", confirmed_delivery="2026-04-18", created_at="2026-03-26T10:00:00", updated_at="2026-03-27T11:00:00"),
        Order(id="ORD-2026-003", customer_id="CUST-003", customer_name="박민수", company_name="(주)대한건설", contact="031-345-6789", shipping_address="경기도 수원시 장안구 정조로 123", total_amount=5500000, status="pending", requested_delivery="2026-05-01", confirmed_delivery="", created_at="2026-03-29T08:30:00", updated_at="2026-03-29T08:30:00"),
        Order(id="ORD-2026-004", customer_id="CUST-004", customer_name="정수빈", company_name="(주)경기도시공사", contact="031-456-7890", shipping_address="경기도 성남시 분당구 정자동 45-6", total_amount=1700000, status="completed", requested_delivery="2026-03-28", confirmed_delivery="2026-03-27", created_at="2026-03-15T09:00:00", updated_at="2026-03-27T16:00:00"),
        Order(id="ORD-2026-005", customer_id="CUST-005", customer_name="최동현", company_name="(주)부산항만공사", contact="051-567-8901", shipping_address="부산광역시 중구 충장대로 206", total_amount=7000000, status="reviewing", requested_delivery="2026-04-25", confirmed_delivery="", created_at="2026-03-30T07:00:00", updated_at="2026-03-30T07:00:00"),
        Order(id="ORD-2026-006", customer_id="CUST-006", customer_name="한지민", company_name="(주)인천공항공사", contact="032-678-9012", shipping_address="인천광역시 중구 공항로 272", total_amount=9200000, status="approved", requested_delivery="2026-04-10", confirmed_delivery="", created_at="2026-03-24T11:00:00", updated_at="2026-03-28T09:00:00"),
        Order(id="ORD-2026-007", customer_id="CUST-007", customer_name="윤서준", company_name="(주)대전도시공사", contact="042-789-0123", shipping_address="대전광역시 서구 둔산로 100", total_amount=2400000, status="approved", requested_delivery="2026-04-30", confirmed_delivery="", created_at="2026-03-31T08:00:00", updated_at="2026-04-01T10:00:00"),
        Order(id="ORD-2026-008", customer_id="CUST-008", customer_name="강예린", company_name="(주)울산항만공사", contact="052-890-1234", shipping_address="울산광역시 남구 장생포로 55", total_amount=4800000, status="approved", requested_delivery="2026-04-08", confirmed_delivery="", created_at="2026-03-22T07:30:00", updated_at="2026-03-25T14:00:00"),
    ]
    db.add_all(rows)
    db.commit()
